...
import { InstagramInboundActivity } from '../components/InstagramInboundActivity'
  ...
  return <section className="connection-detail workspace-detail">
    ...
    <div className="workspace-tab-content">
      ...
      {activeTab === 'general' ? <>
        ...
        {connection.channel.id === 'instagram' && connection.provider.id === 'meta' ? <><InstagramConnectionPanel connection={connection} onConnectionChange={setConnection} /><InstagramInboundActivity connectionId={connection.id} /></> : null}
